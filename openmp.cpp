...
#pragma omp parallel sections default(none) shared(off1, off2)
    {
#pragma omp section
        mutate_drawing(off1);
...
#pragma omp parallel for default(none) shared(g, orig_img)
...
#pragma omp parallel for default(none) shared(g, next)
